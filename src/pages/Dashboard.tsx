...
export const Dashboard: React.FC<DashboardProps> = ({ onNavigate }) => {
  ...
  // 1. Data matching Reference Image for "حصص اليوم"
  const todaySessionsData = [
    {
      id: 1,
      studentsCount: 12,
      course: 'أساسيات الحاسب',
      groupName: 'المجموعة الأولى',
      time: '09:00 ص',
      dotColor: '#00f0ff', // Cyan
    },
    {
      id: 2,
      studentsCount: 10,
    ...
    },
    {
      ...
      studentsCount: 11,
      course: 'برمجة Python',
      groupName: 'المجموعة الخامسة',
      time: '05:00 م',
      dotColor: '#f43f5e', // Rose
    },
  ];

  // 2. Data matching Reference Image for "آخر المدفوعات"
  const recentPaymentsData = [
    {
      ...
      amount: '300',
      date: '2025/09/13',
      avatarColor: 'bg-sky-500/20 text-sky-400 border-sky-400/30',
    },
    {
      id: 2,
      ...
      amount: '450',
      date: '2025/09/13',
      avatarColor: 'bg-emerald-500/20 text-emerald-400 border-emerald-400/30',
    },
    {
      id: 3,
      studentName: 'علي حسن',
      amount: '250',
      date: '2025/09/12',
      avatarColor: 'bg-rose-500/20 text-rose-400 border-rose-400/30',
    },
    {
      id: 4,
    ...
    {
      id: 5,
      studentName: 'يوسف عصام',
      amount: '400',
      date: '2025/09/11',
      avatarColor: 'bg-amber-500/20 text-amber-400 border-amber-400/30',
    },
  ];

  // 3. Weekly Bar Stats Data (السبت .. الجمعة)
  const barData = [
    { day: 'السبت', height: 18, value: 18 },
    { day: 'الأحد', height: 22, value: 22 },
    { day: 'الأثنين', height: 32, value: 32 },
    { day: 'الثلاثاء', height: 33, value: 33 },
    { day: 'الأربعاء', height: 23, value: 23 },
    { day: 'الخميس', height: 20, value: 20 },
    { day: 'الجمعة', height: 20, value: 20 },
  ];

  // 4. Course Distribution Data for Donut Chart
  const courseDistribution = [
    { name: 'أساسيات الحاسب', pct: 28, color: '#00e5ff' },
    { name: 'أوفيس', pct: 22, color: '#10b981' },
    { name: 'إنترنت وتطبيقات', pct: 18, color: '#6366f1' },
    { name: 'تصميم جرافيك', pct: 16, color: '#f43f5e' },
    { name: 'برمجة Python', pct: 16, color: '#f59e0b' },
  ];

  // 5. Important Events Data
  const importantEvents = [
    ...
    {
      id: 2,
      title: 'اختبار نهاية الشهر',
      date: '2025/09/20',
    },
    {
      id: 3,
      title: 'مراجعة شاملة للمجموعات',
      date: '2025/09/25',
    },
  ];
    ...
    <div className="space-y-5 select-none" dir="rtl">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6">
          {/* Left Text: مرحباً بك في زين / لإدارة الدروس والسناتر */}
          <div className="text-right flex-1 min-w-[260px]">
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-3 font-normal">
              كل ما تحتاجه لإدارة سنترك في مكان واحد
            </p>
          </div>

          {/* Center Quote: العلم يمنحك فرصةً أكبر في الحياة */}
          ...
          {/* Far Right Graphic: Computer Lab & Stacked Books (Learn, Practice, Improve, Succeed) */}
          <div className="relative w-full max-w-[280px] sm:max-w-[320px] h-36 shrink-0 flex items-center justify-end">
            ...
            >
              ...
              {/* Background ambient warm lamp glow */}
              ...
              {/* Stack of 4 Books matching reference: Succeed, Improve, Practice, Learn */}
              {/* 4: Succeed (Bottom) */}
      ...
      {/* ========================================================================= */}
      {/* 2. FIVE METRIC CARDS ROW (Exact 5 Cards from Reference Image)             */}
      {/* ========================================================================= */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5 sm:gap-4">
        {/* Card 1: إجمالي الطلاب (124 | ↑ 12%) */}
        <div
        ...
        >
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="text-left">
              ...
              <span className="text-3xl font-extrabold text-white block mt-0.5 tracking-tight">
                124
              </span>
          ...
          {/* Bottom Sine Wave Sparkline (Cyan) */}
        ...
        {/* Card 4: إجمالي المدفوعات (12,450 | ↑ 18%) */}
        <div
        ...
        >
          <div className="flex items-start justify-between">
            ...
            <div className="text-left">
              ...
              <span className="text-2xl sm:text-3xl font-extrabold text-white block mt-0.5 tracking-tight">
                12,450
              </span>
              <div className="flex items-center justify-end gap-1 text-xs font-bold text-emerald-400 mt-1">
                <span>↑ 18%</span>
        ...
        {/* Card 5: المبالغ المتبقية (4,800 | ↑ 10%) */}
        <div
      ...
      {/* ========================================================================= */}
      {/* 3. TWO MAIN DATA TABLES (حصص اليوم + آخر المدفوعات)                       */}
      {/* ========================================================================= */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        {/* ------------------------------------------------------------- */}
        {/* TABLE 1: حصص اليوم (Matching exact columns and rows)           */}
        {/* ------------------------------------------------------------- */}
        <div
        ...
        >
          ...
          <div className="flex items-center justify-between pb-3.5 border-b border-[#142642]">
            ...
            {/* Title with Calendar Icon (Right in RTL) */}
            <div className="flex items-center gap-2">
              <h3 className="text-sm sm:text-base font-bold text-white">حصص اليوم</h3>
        ...
        {/* ------------------------------------------------------------- */}
        {/* TABLE 2: آخر المدفوعات (Matching exact columns and rows)       */}
        {/* ------------------------------------------------------------- */}
        <div
        ...
        >
          ...
          <div className="flex items-center justify-between pb-3.5 border-b border-[#142642]">
            ...
            {/* Title with Payment Icon (Right in RTL) */}
            <div className="flex items-center gap-2">
              <h3 className="text-sm sm:text-base font-bold text-white">آخر المدفوعات</h3>
      ...
      {/* ========================================================================= */}
      {/* 4. BOTTOM THREE CARDS (إحصائيات سريعة + توزيع الكورسات + مواعيد مهمة)   */}
      {/* ========================================================================= */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {/* ------------------------------------------------------------- */}
        {/* CARD 1: إحصائيات سريعة (Weekly Bar Chart)                      */}
        {/* ------------------------------------------------------------- */}
        <div
        ...
        >
          ...
          <div className="flex items-center justify-between pb-3 border-b border-[#142642]">
            ...
            {/* Title with BarChart Icon */}
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-bold text-white">إحصائيات سريعة</h4>
              <BarChart3 className="w-4 h-4 text-sky-400" />
            </div>
          </div>

          {/* Bar Chart Graphics (Scale 0 to 40, Days: السبت .. الجمعة) */}
          <div className="mt-4 pt-2">
            <div className="relative h-44 flex items-end justify-between px-2">
              {/* Y-axis Labels on Far Left (or RTL right side) */}
              ...
              <div className="w-full flex items-end justify-around pr-8 pl-1 pb-6 h-full">
                {barData.map((item) => (
                  <div key={item.day} className="flex flex-col items-center gap-2 group">
                    {/* Bar */}
                    <div className="relative w-5 sm:w-6 rounded-t-md bg-[#0066ff] bg-gradient-to-t from-[#0055ee] to-[#00d4ff] hover:from-[#0066ff] hover:to-[#55f0ff] transition-all shadow-[0_0_12px_rgba(0,180,255,0.3)] cursor-pointer"
        ...
        {/* ------------------------------------------------------------- */}
        {/* CARD 2: توزيع الطلاب على الكورسات (Donut Chart & Legend)       */}
        {/* ------------------------------------------------------------- */}
        <div
        ...
        >
          ...
          {/* Content: Donut SVG + Legend on Right */}
          <div className="flex items-center justify-between gap-4 mt-4">
            {/* Donut Chart (SVG) */}
            <div className="relative w-32 h-32 shrink-0 flex items-center justify-center">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 120 120">
                {/* Donut Slices */}
                {/* 1. أساسيات الحاسب (28%) - Cyan */}
                <circle
                  cx="60"
                  cy="60"
                  r="45"
                  ...
                  stroke="#00e5ff"
                  strokeWidth="16"
                  strokeDasharray={`${(28 / 100) * 282.7} 282.7`}
                  strokeDashoffset="0"
                />
                {/* 2. أوفيس (22%) - Emerald */}
                <circle
                  ...
                  stroke="#10b981"
                  strokeWidth="16"
                  strokeDasharray={`${(22 / 100) * 282.7} 282.7`}
                  strokeDashoffset={`-${(28 / 100) * 282.7}`}
                />
                {/* 3. إنترنت وتطبيقات (18%) - Purple/Indigo */}
                <circle
                  cx="60"
                  cy="60"
                  r="45"
                  ...
                  stroke="#6366f1"
                  strokeWidth="16"
                  strokeDasharray={`${(18 / 100) * 282.7} 282.7`}
                  strokeDashoffset={`-${((28 + 22) / 100) * 282.7}`}
                />
                {/* 4. تصميم جرافيك (16%) - Rose */}
                <circle
                  cx="60"
                  cy="60"
                  r="45"
                  ...
                  stroke="#f43f5e"
                  strokeWidth="16"
                  strokeDasharray={`${(16 / 100) * 282.7} 282.7`}
                  strokeDashoffset={`-${((28 + 22 + 18) / 100) * 282.7}`}
                />
                {/* 5. برمجة Python (16%) - Amber */}
                <circle
                  cx="60"
                  cy="60"
                  r="45"
                  ...
                  strokeWidth="16"
                  strokeDasharray={`${(16 / 100) * 282.7} 282.7`}
                  strokeDashoffset={`-${((28 + 22 + 18 + 16) / 100) * 282.7}`}
                />
              </svg>

              {/* Inner Hole Text: 124 طالب */}
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-xl font-extrabold text-white tracking-tight">124</span>
            ...
            <div className="flex-1 space-y-1.5 text-xs text-right">
              {courseDistribution.map((item) => (
                <div key={item.name} className="flex items-center justify-between gap-2">
                  <span className="font-bold text-slate-300 text-[11px]">{item.pct}%</span>
        ...
        {/* ------------------------------------------------------------- */}
        {/* CARD 3: مواعيد مهمة (Important Events)                         */}
        {/* ------------------------------------------------------------- */}
        <div
